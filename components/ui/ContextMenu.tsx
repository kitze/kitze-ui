...
import { HiCheck, HiChevronRight, HiPlusCircle } from "react-icons/hi";
import { cn } from "../../cn";
...
>(({ className, children, classNames = {}, ...props }, ref) => (
  ...
  >
    <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
      <ContextMenuPrimitive.ItemIndicator>
        <HiPlusCircle className="h-2 w-2 fill-current" />
      </ContextMenuPrimitive.ItemIndicator>
    </span>
    {children}
  </ContextMenuPrimitive.RadioItem>
...
>(({ className, classNames = {}, ...props }, ref) => (
  <ContextMenuPrimitive.Separator
    ref={ref}
    className={cn("-mx-1 my-1 h-px bg-border", className, classNames.separator)}
    {...props}
  />
));
